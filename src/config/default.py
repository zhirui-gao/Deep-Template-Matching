...
_CN.TM.SUPERPOINT.NAME = 'superpoint_glue'  #
...
_CN.TM.MATCH_COARSE.TRAIN_STAGE = 'only_coarse'  # 'whole' or 'only_coarse'
_CN.TM.MATCH_COARSE.USE_EDGE = True  # 'whole' or 'only_coarse'
