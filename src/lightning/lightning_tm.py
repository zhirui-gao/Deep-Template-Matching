...
from src.utils.metrics import compute_distance_errors, aggregate_metrics, compute_distance_errors_train, \
    compute_distance_errors_test
...
class PL_Tm(pl.LightningModule):
    ...
    def _compute_metrics(self, batch):
        ...
        with self.profiler.profile("Copmute metrics"):
            compute_distance_errors_train(batch)
